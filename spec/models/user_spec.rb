...
RSpec.describe User, type: :model do
  describe 'Validations' do
    user = User.new(first_name: "Michel",last_name: "Motongi", email: "michelmotongi@gmail.com", password: "password", password_confirmation: "password")
    ...
    it "doesn't create a user without password or password_confirmation" do
        @user = User.new(first_name: "Michel",last_name: "Motongi", email: "michelmotongi@gmail.com", password: "", password_confirmation: "")
        @user.save
        expect(@user.errors.messages[:password_confirmation]).to eq ["can't be blank"]
    end

    it "doesn't create a user without a last name" do
        @user = User.new(first_name: "",last_name: "", email: "michelmotongi@gmail.com", password: "password", password_confirmation: "password")
        @user.save
        expect(@user.errors.messages[:last_name]).to eq ["can't be blank"]
    end

    it "doesn't create a user without a first name" do
      @user = User.new(first_name: "",last_name: "", email: "michelmotongi@gmail.com", password: "password", password_confirmation: "password")
      @user.save
    ...
    it "doesn't create a user without an email" do
        @user = User.new(first_name: "Michel",last_name: "Motongi", email: "", password: "password", password_confirmation: "password")
        @user.save
        expect(@user.errors.messages[:email]).to eq ["can't be blank"]
    end
    
    it "has a password longer than the minimum lenght requirement" do
        @user = User.new(first_name: "Michel",last_name: "Motongi", email:"michelmotongi@gmail.com", password: "1234", password_confirmation: "1234")
        @user.save
  ...
  describe '.authenticate_with_credentials' do
    it "authenticates the user based on email address and password" do
      @user = User.new(first_name: "Michel",last_name: "Motongi", email: "michelmotongi@gmail.com", password: "12345", password_confirmation: "12345")
      @user.save
